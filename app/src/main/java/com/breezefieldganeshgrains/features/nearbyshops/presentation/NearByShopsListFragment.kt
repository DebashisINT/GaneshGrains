package com.breezefieldganeshgrains.features.nearbyshops.presentation
...
import com.breezefieldganeshgrains.app.utils.AppUtils.Companion.changeAttendanceDateFormatToCurrent
import com.breezefieldganeshgrains.app.utils.FTStorageUtils
import com.breezefieldganeshgrains.app.utils.NotificationUtils
...
import com.breezefieldganeshgrains.features.addshop.model.QuestionSubmit
import com.breezefieldganeshgrains.features.addshop.model.UpdateAddrReq
import com.breezefieldganeshgrains.features.addshop.model.UpdateAddressShop
...
import com.breezefieldganeshgrains.features.addshop.presentation.*
...
import com.breezefieldganeshgrains.features.marketing.api.marketingcategorylist.MarketingCatListRepoProvider
import com.breezefieldganeshgrains.features.marketing.model.MarketingCategoryListResponse
...
import com.breezefieldganeshgrains.features.nearbyshops.model.StageListResponseModel
...
import com.breezefieldganeshgrains.features.viewAllOrder.interf.QaOnCLick
...
//                            val uri = Uri.fromFile(file)
                ...
                val path = Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS).toString() +"/breezefieldganeshgrainsApp/SHOPDtls/"
                var pathNew = ""
                val dir = File(path)
                if (!dir.exists()) {
                    dir.mkdirs()
