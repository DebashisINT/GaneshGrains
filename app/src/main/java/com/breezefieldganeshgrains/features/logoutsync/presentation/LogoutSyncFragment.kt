package com.breezefieldganeshgrains.features.logoutsync.presentation
...
import com.breezefieldganeshgrains.app.AppDatabase
...
import com.breezefieldganeshgrains.app.utils.Toaster
import com.breezefieldganeshgrains.base.BaseResponse
import com.breezefieldganeshgrains.base.presentation.BaseActivity
import com.breezefieldganeshgrains.base.presentation.BaseActivity.Companion.compositeDisposable
...
import com.breezefieldganeshgrains.features.billing.api.AddBillingRepoProvider
import com.breezefieldganeshgrains.features.billing.model.AddBillingInputParamsModel
...
import com.breezefieldganeshgrains.features.dashboard.presentation.ReasonDialog
...
import com.breezefieldganeshgrains.features.document.model.AddEditDocumentInputParams
import com.breezefieldganeshgrains.features.document.model.DocumentAttachmentModel
...
import com.breezefieldganeshgrains.features.nearbyshops.api.updateaddress.ShopAddressUpdateRepoProvider
...
import com.breezefieldganeshgrains.features.orderhistory.api.LocationUpdateRepositoryProviders
import com.breezefieldganeshgrains.features.orderhistory.model.*
...
import com.breezefieldganeshgrains.features.quotation.model.AddQuotInputModel
import com.breezefieldganeshgrains.features.shopdetail.presentation.api.EditShopRepoProvider
import com.breezefieldganeshgrains.features.shopdetail.presentation.api.addcollection.AddCollectionRepoProvider
import com.breezefieldganeshgrains.features.shopdetail.presentation.model.addcollection.AddCollectionInputParamsModel
...
import com.breezefieldganeshgrains.features.stockAddCurrentStock.ShopAddCurrentStockList
...
import com.breezefieldganeshgrains.features.timesheet.model.AddTimeSheetInputModel
import com.breezefieldganeshgrains.features.viewAllOrder.api.addorder.AddOrderRepoProvider
import com.breezefieldganeshgrains.features.viewAllOrder.model.AddOrderInputParamsModel
import com.breezefieldganeshgrains.features.viewAllOrder.model.AddOrderInputProductList
import com.breezefieldganeshgrains.mappackage.SendBrod
import com.breezefieldganeshgrains.widgets.AppCustomTextView
import com.breezefieldganeshgrains.MonitorService
import com.breezefieldganeshgrains.MySingleton
import com.breezefieldganeshgrains.app.AlarmReceiver
...
import com.breezefieldganeshgrains.features.addshop.presentation.ShopExtraContactReq
...
import com.breezefieldganeshgrains.features.dashboard.presentation.model.AudioSyncModel
...
import com.breezefieldganeshgrains.features.orderITC.SyncDeleteOpptL
...
import com.breezefieldganeshgrains.features.orderITC.SyncOpptProductL
import com.breezefieldganeshgrains.features.orderITC.SyncOrd
import com.breezefieldganeshgrains.features.orderITC.SyncOrdProductL
import com.breezefieldganeshgrains.features.performance.model.Gps_status_list
import com.breezefieldganeshgrains.features.performance.model.UpdateGpsInputListParamsModel
import com.breezefieldganeshgrains.features.returnsOrder.ReturnProductList
import com.breezefieldganeshgrains.features.returnsOrder.ReturnRequest
import com.breezefieldganeshgrains.features.viewAllOrder.model.NewOrderSaveApiModel
import com.breezefieldganeshgrains.features.viewAllOrder.model.NewStockSync
                                 ...
                                 doAsync {
                                     ...
                                     uiThread {
                                         ...
                                         try {
                                             ...
                                             var audFile = File("/data/user/0/com.breezefieldganeshgrains/files", fileName)
                                             audFile.delete()
                                         }catch (ex:Exception){
                                             ex.printStackTrace()
                                         }
...
//            checkToCallActivity()
    ...
    private fun callLogshareApi(){
        ...
        if(Pref.LogoutWithLogFile){
            try{
                val filesForZip: Array<String> = arrayOf(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xbreezefieldganeshgrainslogsample/log").path)
                ZipOutputStream(BufferedOutputStream(FileOutputStream(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xbreezefieldganeshgrainslogsample/log.zip").path))).use { out ->
                ...
                val fileUrl = Uri.parse(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xbreezefieldganeshgrainslogsample/log.zip").path);
