package com.breezefieldganeshgrains.features.commondialogsinglebtn
...
import com.breezefieldganeshgrains.app.domain.ShopVisitCompetetorModelEntity
import com.breezefieldganeshgrains.app.domain.VisitRemarksEntity
...
import com.breezefieldganeshgrains.features.addshop.presentation.ProspectListDialog
import com.breezefieldganeshgrains.features.dashboard.presentation.DashboardActivity
import com.breezefieldganeshgrains.features.dashboard.presentation.VisitMultiContactAdapter
...
import com.breezefieldganeshgrains.features.nearbyshops.model.ProsListResponseModel
...
//                        mListener.onOkClick(tv_remarks_dropdown.text.toString().trim(), nextVisitDate, filePath,et_approxvalue_name.text.toString(),ProsId)
            ...
            audioRecRoot.id,et_audioNW.id ->{
                ...
                audioFileNW = File("/data/user/0/com.breezefieldganeshgrains/files", "recorded_audio${System.currentTimeMillis()}.mp3")
